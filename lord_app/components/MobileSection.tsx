...
export default function SmartReportSection() {
  return (
    <div className="w-full px-14 bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-1 items-center">
          ...
          <div className="lg:col-span-5 col-span-1 text-center lg:text-left">
            <div className="space-y-10">
              {/* Main Heading */}
              <h3 className="text-2xl lg:text-3xl font-bold text-[#1a9ca6] leading-tight">
                Healthians Smart Report
              </h3>

              {/* Subheading */}
              <h5 className="text-2xl lg:text-2xl text-[#848484] font-normal">
                Now understanding lab<br />
                reports got easier
              </h5>

              {/* Secondary Heading */}
              <h6 className="text-2xl lg:text-2xl text-[#1a9ca6] font-semibold">
          ...
          <div className="lg:col-span-4 lg:col-start-7 col-span-1">
            <div className="relative w-full flex justify-center lg:justify-end">
              <div className="relative w-full max-w-2xl mr-8 ">
                <img
