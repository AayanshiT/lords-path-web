        ...
        <div className="max-[85rem] mx-auto flex flex-col items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto bg-white rounded-sm">
            ...
            <button
              ...
              className="bg-[#FF3B3B] hover:bg-[#FF3B3B]/80 text-white px-6 py-3 rounded-tr-[4px] rounded-br-[4px] rounded-tl-0 rounded-bl-0 font-semibold whitespace-nowrap transition-colors text-[16px]"
            >
              Get a Call Back
            </button>
          </div>
